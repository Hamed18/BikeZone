...
const Newsletter = () => {
  ...
  return (
    <Card className="relative py-12 w-full overflow-hidden">
      <div className="absolute inset-0 z-10" />
      <div className="relative z-20 flex flex-col items-center justify-center h-full container  text-center px-4 space-y-6">
        <SectionTitle subtitle="Newsletter" title="Latest Bike Listings" />
