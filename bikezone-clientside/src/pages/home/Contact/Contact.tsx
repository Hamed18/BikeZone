...
const Contact = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 w-full px-4 md:px-0 md:w-10/12 mx-auto gap-10 md:gap-32 min-h-screen justify-center items-center">
      <div>
        ...
        <div className="grid grid-cols-1 gap-10">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <Link to="mailto:info@bikeshop.com" className=" hover:underline">
                info@bikeshop.com
              </Link>
            </div>
          </div>
