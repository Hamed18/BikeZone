          ...
          <div className="max-w-md w-full shadow-xl" key={product?._id}>
            <div className="relative">
              <img
                alt="Banner Profile"
                src={product.image}
                className="w-full rounded-t-2xl h-52 object-cover"
              />
            ...
            <div className="p-5">
              <div className="text-gray-400 text-base mt-5 ">
                <span
              ...
              {/* Fake Reviews */}
              <div className="flex items-start justify-center gap-1 mt-2 text-yellow-500">
                <Star size={16} />
                <Star size={16} />
                <Star size={16} />
                <Star size={16} />
